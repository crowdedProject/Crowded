    ...
    return (
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input type="number" className="form-control" name="seats" min="1" max="10" placeholder={this.props.cafeId.noise}/>
        </div>

        <div className="form-group">
          <label>Number of Outlets</label>
          <input type="number" className="form-control" name="outlets" min="1" max="10"/>
        </div>
        ...
        <div className="form-group">
          ...
          <input type="number" className="form-control" name="coffeeQuality" min="1" max="5"/>
        </div>

        <div className="form-group">
          <label>Ambiance</label>
          <input type="number" className="form-control" name="ambiance" min="1" max="5"/>
        </div>

        <div className="form-group">
          <label>Bathroom Quality</label>
          <input type="number" className="form-control" name="bathroomQuality" min="1" max="5"/>
        </div>

        <div className="form-group">
          <label>Noise Level</label>
          <input type="number" className="form-control" name="noise" min="1" max="5"/>
        </div>

        <div className="form-group">
          <label>How Crowded</label>
          <input type="number" className="form-control" name="crowded" min="1" max="5"/>
        </div>

        <div className="form-group">
          <label>Price Level</label>
          <input type="number" className="form-control" name="price" min="1" max="5"/>
        </div>
